...
Route::group(['middleware' => 'auth:api_admin'], function() {
    ...
    //product galleries resource
    Route::apiResource('/galleries',App\Http\Controllers\Api\Admin\ProductGalleryController::class, ['except' => ['create', 'edit'], 'as' => 'admin']);
    //products resource
...
Route::prefix('web')->group(function () {
    ...
    //galleries route
    Route::get('/galleries',[App\Http\Controllers\Api\Web\ProductGalleryController::class, 'galleries'], ['as' => 'web']);
    //galleries resource
    Route::apiResource('/products-gallery',App\Http\Controllers\Api\Web\ProductGalleryController::class,  ['except' =>['create', 'store', 'edit', 'update', 'destroy'], 'as' => 'web']);
    //rajaongkir
